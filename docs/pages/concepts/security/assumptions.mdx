...
The Vulcan layer, composed of a committee of auditors, verifies the correctness of blocks from applications. Operating under an honest-majority assumption, this layer ensures that data integrity and application behavior adhere to predefined rules. The committee’s role is crucial for maintaining system integrity, with mechanisms in place to mitigate potential liveliness failures.
