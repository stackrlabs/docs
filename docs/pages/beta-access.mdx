...
You can request beta access to the Stackr's SDK and CLI filling up this form and signing up for the beta program. Over Sepolia Network. (Sepolia funds required to sign up)
...
Proceed to the [Zero-to-One](/zero-to-one/run-it) section to start building your very own microrollup!
