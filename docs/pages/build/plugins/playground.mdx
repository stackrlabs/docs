...
<Callout type="info">
If you're having problem with the Playground website not being able to load your micro-rollups data, try turning off the Brave Shield if you're on Brave Browser, and similar settings if this problem is encountered in other browsers.
</Callout>
...
playground.addGetMethod('/custom/state', (_req, res) => { // [!code focus]
  return res.send({ state: pointsMachine?.state }); // [!code focus]
}); // [!code focus]
```
...
<center>
    <img src="/assets/get-handler.png" width={320} alt="Stackr Playground | Custom Get Handler" />
</center>
...
<center>
    <img src="/assets/get-response.png" width={512} alt="Stackr Playground | Get State Response" />
</center>
