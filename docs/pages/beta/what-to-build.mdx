...
This section assumes basic knowledge of the Stackr's stack & micro-rollups. We highly recommend reading through the [Micro-Rollups](/concepts/micro-rollup/introduction) section as to better match the mental models of how the ideas listed in this section can be built as micro-rollups.

But, first…

## Why build micro-rollups?

Micro-Rollups are essentially sufficiently decentralised backends. Building your application or a sidecar to an existing application(read [Utility Modes](/concepts/micro-rollup/utility)) on a micro-rollup offers you the following benefits —
