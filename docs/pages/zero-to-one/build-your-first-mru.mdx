...
- Update the following values in the `.env` file. 
  - You can get the latest values listed in the [Providers and RPCs](/references/providers-and-rpc) Page.
...
:::info
`PRIVATE_KEY` is the private key of account you signed up for Beta access with.
...
- `machine.ts` contains the `StateMachine` and `State` classes for your application.
  - Please make sure to make a named export the `StateMachine` class from this file. Like below:
...
- [Checking your WASM Binary](/guides/checking-your-binaries)
